html>
    ...
    <style>
        ...
        <div class="modal">
            <form class="form" action="/BurgetEatJSP/Checkout" method="post">
                ...
                <button type="submit"  onclick="accionOpcion7()" class="purchase--btn">PAGAR</button>
            </form>
        </div>
                                    
                                    <script>
                        function accionOpcion7() {
    
    window.location.href = "confirmado.jsp";
}
                                    </script>
